...
class SCRAP_DATA:
    ...
    def get_images(self) -> list:
        ...
        if isinstance(self.urls, str):
            ...
            try:
                requested = httpx.get(self.urls, timeout=15)
            ...
            for i in self.urls:
                ...
                try:
                    ...
                    requested = httpx.get(i, timeout=15)
    ...
    def get_videos(self) -> list:
        ...
        if isinstance(self.urls, str):
            ...
            try:
                ...
                requested = httpx.get(self.urls, timeout=20)
            ...
            for i in self.urls:
                ...
                try:
                    ...
                    requested = httpx.get(i, timeout=20)
...
class INSTAGRAM:
    ...
    def is_correct_url(self):
        ...
        return bool(
            (re.compile(r"^https?://(?:www\.)?instagram\.com/")).match(self.url)
        )
