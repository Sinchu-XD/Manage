...
@Gojo.on_message(command(["disapprove", "unapprove"]) & admin_filter)
...
@Gojo.on_message(command("unapproveall") & filters.group & owner_filter)
...
• /approve: Approve a user. Locks, blacklists, and antiflood won't apply to them anymore.
• /unapprove: Remove approval of a user.
• /approved: List all approved users.
• /unapproveall: Unapprove ALL users in a chat.
