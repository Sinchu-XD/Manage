...
You can donate by contacting my owner: [Abhishek](http://t.me/WtfShia)
     """
...
Join my [News Channel](https://t.me/ProNovaUpdates) to get information on all the latest updates."""
            ...
            [
                [
                    InlineKeyboardButton(
                        "Connect me to pm",
                        url=f"https://t.me/{c.me.username}",
                    ),
                ],
            ],
        )
...
Join my [News Channel](http://t.me/ProNovaUpdates) to get information on all the latest updates."""
    ...
    if len(m.text.split()) >= 2:
        ...
        if m.chat.type == ChatType.PRIVATE:
            if len(help_msg) >= 1026:
                await m.reply_text(help_msg, parse_mode=enums.ParseMode.MARKDOWN)
                return
            await m.reply_photo(
                photo=str(choice(StartPic)),
                caption=help_msg,
